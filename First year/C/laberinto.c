...
void una_solucion(int tablero[max][max])
{
        ...
        if (buscar_una_solucion(tablero, 0, 0)) //busca la solucion desde el punto cero,cero
        {
                printf("hay solucion!\n\n");
...
void camino_corto(int tablero[max][max])
{
        ...
        buscar_camino_corto(tablero, 0, 0); //busca la solucion desde el punto cero,cero
        exit(0);
}
...
void varias_soluciones(int tablero[max][max])
{
        ...
        buscar_todas_soluciones(tablero, 0, 0); //busca la solucion desde el punto cero,cero
        exit(0);
}
...
void imprimir_tableros_solucion(int tablero[max][max], int x, int y, int almacenar_contadores[200000], int contador, int posicion)
{
        // este modulo es igual al anterior, solo que con la diferencia que en vez de imprimir todos los tableros,
        // solo imprimira los tableros con movimientos = contador, ej: 11.
        //
        ...
        while (opcion < 4)
        {
                ...
                if (valido(tablero, ny, nx))
                {
                        ...
                        if (ny == yfinal && nx == xfinal)
                        {
                                ...
                                if (contador == almacenar_contadores[0]) // aqui si la posicion final de x e y = contador (que es el menor en este caso)
