 ...
 * class construction.
 * 
 * @author <a href="https://tips4java.wordpress.com/2009/11/29/text-prompt/">Rob
 *         Camick</a>
 * @version 2.0.0
 * @since 2.0.0
 */
public class TextPrompt extends JLabel implements FocusListener, DocumentListener {
	private static final long serialVersionUID = -8033365429654886977L;
	 ...
	 */
	public void changeAlpha(float alpha) { // NO_UCD (unused code)
	 ...
	 */
	public void changeAlpha(int alpha) { // NO_UCD (unused code)
	 ...
	 */
	public void changeStyle(int style) { // NO_UCD (unused code)
